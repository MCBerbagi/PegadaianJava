...
public class DetailForm extends javax.swing.JFrame {
    ...
    GadaiDAO daodetail = new GadaiDAOImp();

    public DetailForm() {
        setLocationRelativeTo(null);
        initComponents();
        int row = GadaiForm.tabelGadai.getSelectedRow();
        int id = Integer.valueOf(GadaiForm.tabelGadai.getValueAt(row, 0).toString()); //        int id1=Integer.valueOf(GadaiForm.tabeltebusan.getValueAt(r,0).toString());
                //        tabeldetail.setModel(daodetail.detail(id1));
               
        tabeldetail.setModel(daodetail.detail(id));
//        int r=GadaiForm.tabeltebusan.getSelectedRow();
    }
    ...
    public static javax.swing.JTable tabeldetail;
